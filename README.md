...
2. It automatically launches Gobuster to brute-force directories on the discovered HTTP service.
...
- Runs Gobuster with 50 threads using a predefined wordlist.
